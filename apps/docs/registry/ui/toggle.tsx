...
const toggleVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        default:
          "hover:bg-bg-surface-hover hover:text-text aria-pressed:bg-bg-surface-secondary",
        outline:
          "border border-border bg-bg-surface hover:bg-bg-surface-hover aria-pressed:bg-bg-surface-secondary",
      },
      size: {
