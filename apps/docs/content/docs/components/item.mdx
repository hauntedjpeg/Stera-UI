...
<ComponentPreview name="item-demo" caption="Item Examples" />

## Installation

<InstallSnippet slug="item" hideHeading />
...
<ComponentPreview name="item-variants" caption="All Variants" />
...
<ComponentPreview name="item-sizes" caption="All Sizes" />
...
<ComponentPreview name="item-icon" caption="Icon" />

### Avatar

Display an `Avatar` within `ItemMedia`.

<ComponentPreview name="item-avatar" caption="Avatar" />

### Header

Use `ItemHeader` to add a header above the item content.

<ComponentPreview name="item-header" caption="Header" />

### Footer

Use `ItemFooter` to add a footer below the item content.

<ComponentPreview name="item-footer" caption="Footer" />
