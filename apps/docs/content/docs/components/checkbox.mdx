...
Built on Base UI's `Checkbox` primitive. See the [Base UI Checkbox API](https://base-ui.com/react/components/checkbox#api-reference) for the full surface. Common props:
