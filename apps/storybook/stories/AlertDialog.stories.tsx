...
/** Use the `size="sm"` prop with `AlertDialogMedia` for a smaller dialog with an icon. */
...
/** Use the `AlertDialogAction` with `variant="destructive"` for a destructive action button. */
